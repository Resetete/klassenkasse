...
const I18N = {
  de: {
    text: {
      ...
      familiesCountLabel: "Aktive Kinder (Familien)",
      ...
      targetAmountLabel: "Zielbetrag pro Kind (Familie) (€)",
      phTargetAmount: "z. B. 25,00",
      targetHint: "Wenn gesetzt: Jedes Kind sollte mindestens diesen Saldo haben.",

      depositTitle: "Einzahlung",
      dateLabel: "Datum",
      familyLabel: "Kind (Familie)",
      amountLabel: "Betrag (€)",
      ...
      expenseSelectLabel: "Kinder (Familien)",
      expenseAllHint: "Alle passenden Kinder (Familien) sind vorausgewählt — abwählen, um auszuschließen.",
      addExpenseBtn: "Ausgabe aufteilen",
      roundingHint: "Cent-Reste werden fair verteilt.",

      addFamilyTitle: "Kind (Familie) hinzufügen",
      familySelectionRadioTitle: "Auswahl",
      selectAllFamilies: "Alle Kinder (Familien) auswählen",
      selectFamilies: "Nur ausgewählte Kinder (Familien)",
      familyRareHint: "Nutze dies, wenn ein neues Kind (Familie) dazu kommt",
      ...
      childrenLabel: "Kind",
      phChildren: "z. B. Mia oder Leo",
      activeFromLabel: "In Klasse ab",
      activeToLabel: "In Klasse bis",
      familyNoteLabel: "Kommentar",
      phFamilyNote: "optional",
      addFamilyBtn: "Kind (Familie) hinzufügen",
      familyHint: "Tipp: Inaktive Kinder (Familien) werden aus Auswahlfeldern ausgeschlossen, bleiben aber in der Historie.",

      familiesTitle: "Kinder (Familien)",
      showActiveFamilies: "Aktive Kinder (Familien)",
      showInactiveFamilies: 'Inaktive Kinder (Familien)',
      ...
      reminderActiveOnly: "Nur aktive Kinder (Familien)",
    ...
    errors: {
      ...
      familyMissing: "Bitte ein Kind (Familie) auswählen.",
      noParticipants: "Bitte mindestens ein Kind (Familie) auswählen.",
    ...
    ui: {
      allPreselectedHint: "Alle passenden Kinder (Familien) sind vorausgewählt — abwählen, um auszuschließen.",
      customSelectHint: "Wähle die Kinder (Familien) aus, auf die die Ausgabe verteilt werden soll.",
      noEligibleFamilies: "Keine passenden Kinder (Familien) für dieses Datum.",
      exportFilename: "klassenkasse-export.json",

      expenseModeAll: "Alle aktiven Kinder (Familien)",
      expenseModeCustom: "Nur ausgewählte Kinder (Familien)",
    },
  },
  en: {
    text: {
      ...
      familiesCountLabel: "Active Children (Families)",
      ...
      targetAmountLabel: "Target amount per child (family) (€)",
      phTargetAmount: "e.g. 25.00",
      targetHint: "If set: each child (family) should have at least this balance.",
      ...
      expenseSelectLabel: "Children (Families)",
      expenseAllHint: "All eligible children (families) are preselected — uncheck to exclude.",
      addExpenseBtn: "Split expense",
      roundingHint: "Cent remainders are distributed fairly.",

      addFamilyTitle: "Add child (family)",
      familyRareHint: "Use this to add new children (families) when they join the class",
      familySelectionRadioTitle: "Selection",
      selectAllFamilies: "Select all children (families)",
      selectFamilies: "Select specific children (families)",
      ...
      childrenLabel: "Child",
      phChildren: "e.g. Mia or Leo",
      activeFromLabel: "In class from",
      activeToLabel: "In class until",
      familyNoteLabel: "Comment",
      phFamilyNote: "optional",
      addFamilyBtn: "Add child (family)",
      familyHint: "Tip: inactive children (families) are excluded from selections, but remain in history.",

      familiesTitle: "Children (Families)",
      showActiveFamilies: "Active Children (Families)",
      showInactiveFamilies: 'Inactive Children (Families)',
      ...
      reminderActiveOnly: "Active children (families) only",
    ...
    errors: {
      ...
      familyMissing: "Please select a child (family).",
      noParticipants: "Please select at least one child (family).",
    ...
    ui: {
      ...
      customSelectHint: "Select the children (families) to split this expense across.",
      noEligibleFamilies: "No eligible families for this date.",
      exportFilename: "classfund-export.json",

      expenseModeAll: "All active children (families)",
      expenseModeCustom: "Selected children (families) only",
    },
  },
};
