...
const I18N = {
  de: {
    text: {
      ...
      familiesCountLabel: "Aktive Kinder",
      ...
      targetAmountLabel: "Zielbetrag pro Kind (€)",
      ...
      expenseSelectLabel: "Kinder",
      expenseAllHint: "Alle passenden Kinder sind vorausgewählt — abwählen, um auszuschließen.",
      addExpenseBtn: "Ausgabe aufteilen",
      roundingHint: "Cent-Reste werden fair verteilt.",

      addFamilyTitle: "Kind hinzufügen",
      familySelectionRadioTitle: "Auswahl",
      selectAllFamilies: "Alle Kinder auswählen",
      selectFamilies: "Nur ausgewählte Kinder",
      familyRareHint: "Nutze dies, wenn ein neues Kind dazu kommt",
      ...
      addFamilyBtn: "Kind hinzufügen",
      familyHint: "Tipp: Inaktive Kinder werden aus Auswahlfeldern ausgeschlossen, bleiben aber in der Historie.",

      familiesTitle: "Kinder",
      showActiveFamilies: "Aktive Kinder",
      showInactiveFamilies: 'Inaktive Kinder',
      ...
      reminderActiveOnly: "Nur aktive Kinder",
    ...
    errors: {
      ...
      familyMissing: "Bitte ein Kind auswählen.",
      noParticipants: "Bitte mindestens ein Kind auswählen.",
    ...
    ui: {
      allPreselectedHint: "Alle passenden Kinder sind vorausgewählt — abwählen, um auszuschließen.",
      customSelectHint: "Wähle die Kinder aus, auf die die Ausgabe verteilt werden soll.",
      noEligibleFamilies: "Keine passenden Kinder für dieses Datum.",
      exportFilename: "klassenkasse-export.json",

      expenseModeAll: "Alle aktiven Kinder",
      expenseModeCustom: "Nur ausgewählte Kinder",
    },
  },
  en: {
    text: {
      ...
      familiesCountLabel: "Active Children",
      ...
      targetAmountLabel: "Target amount per child (€)",
      phTargetAmount: "e.g. 25.00",
      targetHint: "If set: each child should have at least this balance.",
      ...
      expenseSelectLabel: "Children",
      expenseAllHint: "All eligible children are preselected — uncheck to exclude.",
      addExpenseBtn: "Split expense",
      roundingHint: "Cent remainders are distributed fairly.",

      addFamilyTitle: "Add child",
      familyRareHint: "Use this to add new children when they join the class",
      familySelectionRadioTitle: "Selection",
      selectAllFamilies: "Select all children",
      selectFamilies: "Select specific children",
      ...
      phFamilyNote: "optional",
      addFamilyBtn: "Add child",
      familyHint: "Tip: inactive children are excluded from selections, but remain in history.",

      familiesTitle: "Children",
      showActiveFamilies: "Active Children",
      showInactiveFamilies: 'Inactive Children',
      ...
      reminderActiveOnly: "Active children only",
    ...
    errors: {
      ...
      familyMissing: "Please select a child.",
      noParticipants: "Please select at least one child.",
    ...
    ui: {
      allPreselectedHint: "All eligible children are preselected — uncheck to exclude.",
      customSelectHint: "Select the children to split this expense across.",
      noEligibleFamilies: "No eligible children for this date.",
      exportFilename: "classfund-export.json",

      expenseModeAll: "All active children",
      expenseModeCustom: "Selected children only",
    },
  },
};
